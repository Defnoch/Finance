...
namespace Finance.Infrastructure.Migrations
{
    ...
    [Migration("20260203131549_AddTransactionLinkTable")]
    partial class AddTransactionLinkTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance.Domain.Entities.BackgroundTaskRunLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("BackgroundTaskRunLogs");
                });
            ...
            modelBuilder.Entity("Finance.Domain.Entities.BackgroundTaskRunLog", b =>
                {
                    b.HasOne("Finance.Domain.Entities.BackgroundTaskConfig", "TaskConfig")
                        .WithMany("RunLogs")
